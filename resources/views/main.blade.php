...
<section class="w-full px-6 pb-12 antialiased bg-white">
    <div class="mx-auto max-w-7xl">
        ...
        <div class="container max-w-lg px-4 py-32 mx-auto text-left md:max-w-none md:text-center">
            <h1 class="text-5xl font-extrabold leading-10 tracking-tight text-left text-gray-900 md:text-center sm:leading-none md:text-6xl lg:text-7xl"><span class="inline md:block">Welcome to</span> <span class="relative mt-2 text-transparent bg-clip-text bg-gradient-to-br from-purple-700 to-purple-600 md:inline-block">E-Medic</span></h1>
            <div class="mx-auto mt-5 text-gray-500 md:mt-12 md:max-w-lg md:text-center lg:text-lg">Makes Living Better.</div>
            <div class="flex flex-col items-center mt-12 text-center">
                <span class="relative inline-flex w-full md:w-auto">
                    <a href="{{ route('register') }}" type="button" class="inline-flex items-center justify-center w-full px-8 py-4 text-base font-bold leading-6 text-white bg-purple-700 border border-transparent rounded-full md:w-auto hover:bg-purple-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-700">
                        Register Now
                    </a>
                    <span class="absolute top-0 right-0 px-2 py-1 -mt-3 -mr-6 text-xs font-medium leading-tight text-white bg-green-400 rounded-full">Try it</span>
                </span>
                <a href="/about" class="mt-3 text-sm text-purple-700">Learn More</a>
            </div>
        </div>
    ...
    <div class="container max-w-6xl mx-auto">
        ...
        <div class="grid grid-cols-4 gap-8 mt-10 sm:grid-cols-8 lg:grid-cols-12 sm:px-8 xl:px-0">
            ...
            <div class="relative flex flex-col items-center justify-between col-span-4 px-8 py-12 space-y-4 overflow-hidden bg-gray-100 sm:rounded-xl">
                <div class="p-3 text-white bg-purple-700 rounded-full">
                ...
                <p class="text-base text-center text-gray-500">Our team is fully certified.</p>
            </div>
            ...
            <div class="flex flex-col items-center justify-between col-span-4 px-8 py-12 space-y-4 bg-gray-100 sm:rounded-xl">
                ...
                <p class="text-base text-center text-gray-500">Get notified about important medical information.</p>
            </div>
            ...
            <div class="flex flex-col items-center justify-between col-span-4 px-8 py-12 space-y-4 bg-gray-100 sm:rounded-xl">
                ...
                <h4 class="text-xl font-medium text-gray-700">Services</h4>
                <p class="text-base text-center text-gray-500">Special services.</p>
            </div>
            ...
            <div class="flex flex-col items-center justify-between col-span-4 px-8 py-12 space-y-4 bg-gray-100 sm:rounded-xl">
                ...
                <h4 class="text-xl font-medium text-gray-700">Talented Develepers</h4>
                <p class="text-base text-center text-gray-500">Developers work around the clock to keep the application online and up-to-date.</p>
            </div>
            ...
            <div class="flex flex-col items-center justify-between col-span-4 px-8 py-12 space-y-4 bg-gray-100 sm:rounded-xl">
                ...
                <h4 class="text-xl font-medium text-gray-700">Digital Assistant</h4>
                <p class="text-base text-center text-gray-500">Help is here for you.</p>
            </div>
            ...
            <div class="flex flex-col items-center justify-between col-span-4 px-8 py-12 space-y-4 bg-gray-100 sm:rounded-xl">
                ...
                <h4 class="text-xl font-medium text-gray-700">Diagnosis</h4>
                <p class="text-base text-center text-gray-500">Diagnose your symptoms quick and effortlessly.</p>
            </div>
...
<section class="flex items-center justify-center py-20 bg-white min-w-screen">
    <div class="px-16 bg-white">
        <div class="container flex flex-col items-start mx-auto lg:items-center">
            <p class="relative flex items-start justify-start w-full text-lg font-bold tracking-wider text-purple-700 uppercase lg:justify-center lg:items-center">Don't just take our word for it</p>
            ...
            <h2 class="relative flex items-start justify-start w-full max-w-3xl text-5xl font-bold lg:justify-center">
                ...
                <div class="block w-full h-0.5 max-w-lg mt-6 bg-purple-200 rounded-full"></div>
                ...
                <div class="flex flex-col items-start justify-start w-full h-auto mb-12 lg:w-1/3 lg:mb-0">
                    <div class="flex items-center justify-center">
                        ...
                        <div class="flex flex-col items-start justify-center">
                            ...
                            <p class="text-gray-600">CEO of Tenzen</p>
                        </div>
                    </div>
                    <blockquote class="mt-8 text-lg text-gray-500">"This is a no-brainer if you want to take your health to the next level. If you are looking for the ultimate medical care, this is it!"</blockquote>
                </div>
                ...
                <div class="flex flex-col items-start justify-start w-full h-auto lg:w-1/3">
                    <div class="flex items-center justify-center">
                        ...
                        <div class="flex flex-col items-start justify-center">
                            ...
                            <p class="text-gray-600">Creator of Minibuds</p>
                        </div>
                    </div>
...
<section class="bg-white">
    <div class="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
        ...
        <p class="mt-8 text-base leading-6 text-center text-gray-400">
            © 2021 E-Medic, Inc. All rights reserved.
        </p>
    </div>
</section>
